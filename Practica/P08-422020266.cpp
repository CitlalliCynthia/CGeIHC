...
int main()
{
	...
	SlimeFuego_M = Model();
	SlimeFuego_M.LoadModel("Models/slimeFuego.obj");
	Lampara_M = Model();
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		if (mainWindow.getarticulacion4() == 1.0 && mainWindow.getarticulacion5() == 1.0) //ambas apagadas
			shaderList[0].SetPointLights(pointLights, pointLightCount -2);
		else if (mainWindow.getarticulacion4() == 0.0 && mainWindow.getarticulacion5() == 0.0) //ambas encendidas
